  ...
  return (
    <div style={{ minHeight: '100vh', fontFamily: 'sans-serif' }}>
     ...
     <main style={{ padding: '20px' }}>
        <h1>Добро пожаловать в калькулятор монтажа!</h1>
        <p>Калькулятор времени монтажа. 
          Данный калькулятор прогнозирнует продолжительность монтажа одного модуля в проектное положение в зависимости от выбранных организационно-технологических решений. 
          Выберите по каждому пункту (фактору) значения -1 или 1:</p>
